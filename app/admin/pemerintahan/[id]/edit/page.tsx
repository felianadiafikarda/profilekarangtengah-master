// app/admin/pemerintahan/[id]/edit/page.tsx
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="glass-header z-20 flex-shrink-0 px-8 py-4 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Edit Pemerintahan</h1>
          </div>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <EditForm pemerintahan={pemerintahan} />
        </main>
      </div>
    </div>
  );
